...
export const AddScreen = ({navigation, route}) => {
  ...
  const onPressFunc = () => {
    if (Object.keys(data).length) {
      console.log('adres', addressAll);
      console.log('km', km);
      if (name && phone && dateDate && dateTime && addressAll) {
        axiosFunc();
      } else if (!name) {
  ...
  const searchDataYandex = st => {
    ...
    axios
      ...
      .then(res => {
        ...
        console.log('city', cityFromAddress);
        console.log('store', store.city);
  ...
  const discountPercentage = promoFlag
    ? promoCodeNumber === 15
      ? 0.15
      : 0.05
    : 0;
              ...
              <View style={styles.headerContainer}>
                      ...
                      <>
                        <AppInput
                          ...
                          onChangeText={e => {
                            ...
                            setPromoText('');
                            onChangeFunc(upperCaseText, setPromoCode);
                          }}
                        />
                ...
                <View style={[globalStyles.row, styles.footHead]}>
                  <Text
                    ...
                    Итоговая сумма:{' '}
                    <Text style={[globalStyles.weightBold]}>{total} р</Text>
                  </Text>
                  <Text
                    style={[
                      globalStyles.titleText,
